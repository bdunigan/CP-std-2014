<?PHP 
	...
	$frame_sizes = array(
		'4.25x5.75'	=>	'Fall in Love Portrait;',
		'5.75x4.25'	=>	'Fall in Love Landscape;'
	);
	...
	$images_folder = '/frame07/web/';
	$printimages_folder = 'images/frame07/print/';
...
<div class="field" id="select-example">
	...
	<input type="radio"name="example" valone="<?php echo $alt1d;?>" valtwo="<?php echo $alt2d;?>" valthree="<?php echo $alt3d;?>" valfour="<?php echo $alt4d;?>" valthree="<?php echo $alt3d;?>" valfour="<?php echo $alt4d;?>" id="example-dark" checked="checked" >Dark Example
...
<div class="hide"><?php include 'newincludes/select-location.php';?></div>
	...
	<div class="field"><!--COLOR 2-->
		<input type="hidden" name="color2-name" id="color2-name" value="Select Branch Color">
		<label>Select Branch Color:  </label>
