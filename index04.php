<?PHP
	...
	$frame_sizes = array(
		'4.25x5.75'	=>	'Photo Heart Portrait;',
		'5.75x4.25'	=>	'Photo Heart Landscape;'
	);
	...
	$images_folder = '/frame04/web/';
	$printimages_folder = 'images/frame04/print/';
...
<div class=""><?php include 'newincludes/select-location.php';?></div>
	...
	<div class="field"><!--COLOR 3-->
		<input type="hidden" name="color3-name" id="color3-name" value="Text Color">
