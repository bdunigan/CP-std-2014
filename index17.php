<?PHP
	...
	$frame_sizes = array(
		'4.25x5.75'	=>	'Stitched Together Portrait;',
		'5.75x4.25'	=>	'Stitched Together Landscape;'
	);
	...
	$images_folder = '/frame17/web/';
	$printimages_folder = 'images/frame17/print/';
...
<div class="hide"><?php include 'newincludes/select-location.php';?></div>
	...
	<div class="field"><!--COLOR 1-->
		<input type="hidden" name="color1-name" id="color1-name" value="Select Tag Color">
