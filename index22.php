<?PHP
	...
	$frame_sizes = array(
		'4.25x5.75'	=>	'Candy Stripes Portrait;',
		'5.75x4.25'	=>	'Candy Stripes Landscape;'
	);
	...
	$images_folder = '/frame22/web/';
	$printimages_folder = 'images/frame22/print/';
...
<div class="hide"><?php include 'newincludes/select-location.php';?></div>
	...
	<div class="field"><!--COLOR 2-->
		<input type="hidden" name="color2-name" id="color2-name" value="Select Name/Date Color">
