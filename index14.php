<?PHP
	...
	$frame_sizes = array(
		'4.25x5.75'	=>	'Ferris Wheel Portrait;',
		'5.75x4.25'	=>	'Ferris Wheel Landscape;'
	);
	...
	$images_folder = '/frame14/web/';
	$printimages_folder = 'images/frame14/print/';
...
<div class="hide"><?php include 'newincludes/select-location.php';?></div>
	...
	<div class="field"><!--COLOR 1-->
		<input type="hidden" name="color1-name" id="color1-name" value="Select Save Date Color">
		<label>Select Save Date Color:  </label>
	...
	<div class="field"><!--COLOR 2-->
		<input type="hidden" name="color2-name" id="color2-name" value="Select Heart/Arrow Color">
		<label>Select Heart/Arrow Color:  </label>
